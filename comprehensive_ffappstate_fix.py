...
# Get all files that still have problematic FFAppState references
result = subprocess.run([
    'grep', '-r', '-l', 
    'FFAppState()\.itemsProducts\|FFAppState()\.selectRates\|FFAppState()\.allDataHotel\|FFAppState()\.allDataContact\|FFAppState()\.allDataFlight\|FFAppState()\.allDataTransfer\|FFAppState()\.allDataActivity\|FFAppState()\.allDataItinerary\|FFAppState()\.allDataUser', 
    'lib/', '--include=*.dart'
...
print(f"Found {len(files_to_process)} files with problematic FFAppState references")
...
replacements = [
    ...
    (r'FFAppState\(\)\.allDataHotel', 'context.read<UiStateService>().allDataHotel'),
    (r'FFAppState\(\)\.allDataContact', 'context.read<UiStateService>().allDataContact'),
    (r'FFAppState\(\)\.allDataFlight', 'context.read<UiStateService>().allDataFlight'),
    (r'FFAppState\(\)\.allDataTransfer', 'context.read<UiStateService>().allDataTransfer'),
    (r'FFAppState\(\)\.allDataActivity', 'context.read<UiStateService>().allDataActivity'),
    (r'FFAppState\(\)\.allDataItinerary', 'context.read<UiStateService>().allDataItinerary'),
    (r'FFAppState\(\)\.allDataUser', 'context.read<UiStateService>().allDataUser'),
]
...
print(f"\n🎉 Comprehensive migration completed! Modified {files_modified} files.")