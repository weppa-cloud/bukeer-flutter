...
class AuthCreateWidget extends StatefulWidget {
  ...
  static String routeName = 'authCreate';
...
class _AuthCreateWidgetState extends State<AuthCreateWidget>
  ...
  void initState() {
    ...
    _model.nameAccountTextController ??= TextEditingController();
    _model.nameAccountFocusNode ??= FocusNode();
                            ...
                            children: [
                              Expanded(
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.nameAccountTextController,
                                    focusNode: _model.nameAccountFocusNode,
                                    autofocus: true,
                                    obscureText: false,
                            ...
                            child: Row(
                              ...
                              children: [
                                FFButtonWidget(
                                  onPressed: () async {
                                    Function() _navigate = () {};
                                    _model.validateFormAuthCreate = true;
                                    if (_model.formKey.currentState == null ||
                                        !_model.formKey.currentState!
                                            .validate()) {
                                      _model.validateFormAuthCreate = false;
                                    }
                                    if (_model.validateFormAuthCreate!) {
                                      _model.apiResponseAddUser =
                                      ...
                                      if ((_model
                                              .apiResponseAddUser?.succeeded ??
                                          true)) {
                                        _model.apiResponseAddAccounts =
                                            await AddAccountsCall.call(
                                          name: _model
                                              .nameAccountTextController.text,
                                        );

                                        if ((_model.apiResponseAddAccounts
                                                ?.succeeded ??
                                            true)) {
                                          ...
                                          _model.apiResponseAddUserContact =
                                          ...
                                          if ((_model.apiResponseAddUserContact
                                                  ?.succeeded ??
                                              true)) {
                                            GoRouter.of(context)
                                                .prepareAuthEvent();
