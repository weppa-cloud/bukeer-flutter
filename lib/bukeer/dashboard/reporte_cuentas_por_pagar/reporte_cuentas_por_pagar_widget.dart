...
class ReporteCuentasPorPagarWidget extends StatefulWidget {
  const ReporteCuentasPorPagarWidget({super.key});

  static String routeName = 'reporte_cuentas_por_pagar';
  static String routePath = 'reporte_pagar_cuentas';

  @override
  State<ReporteCuentasPorPagarWidget> createState() =>
      _ReporteCuentasPorPagarWidgetState();
}
...
class _ReporteCuentasPorPagarWidgetState
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReporteCuentasPorPagarModel());
        ...
        body: SafeArea(
          ...
          child: FutureBuilder<ApiCallResponse>(
            future: (_model.apiRequestCompleter ??= Completer<ApiCallResponse>()
                  ..complete(GetReporteCuentasPorPagarCall.call(
            ...
            builder: (context, snapshot) {
              ...
              final columnGetReporteCuentasPorPagarResponse = snapshot.data!;
                                ...
                                children: [
                                                                      ...
                                                                      Text(
                                                                        formatNumber(
                                                                          (String
                                                                            ...
                                                                            columnGetReporteCuentasPorPagarResponse.jsonBody,
                                                                            r'''$.total_pending_paid''',
                                                                          ).toString()),
                                                                          formatType:
                                                                              FormatType.decimal,
                                                                          decimalType:
                                  ...
                                  Flexible(
                                    child: Container(
                                      ...
                                      child: Builder(
                                        builder: (context) {
                                          final providerItem = getJsonField(
                                            columnGetReporteCuentasPorPagarResponse
                                                .jsonBody,
                                            r'''$.providers''',
                                          ).toList();
                                          ...
                                          return ListView.separated(
                                            ...
                                            itemCount: providerItem.length,
                                            separatorBuilder: (_, __) =>
                                                SizedBox(height: 10.0),
                                            itemBuilder:
                                                (context, providerItemIndex) {
                                              final providerItemItem =
                                                  providerItem[
                                                      providerItemIndex];
                                              return Padding(
                                                padding: EdgeInsetsDirectional
