...
class DropdownContactosWidget extends StatefulWidget {
  ...
  @override
  State<DropdownContactosWidget> createState() =>
      _DropdownContactosWidgetState();
}

class _DropdownContactosWidgetState extends State<DropdownContactosWidget>
    with TickerProviderStateMixin {
  late DropdownContactosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DropdownContactosModel());
