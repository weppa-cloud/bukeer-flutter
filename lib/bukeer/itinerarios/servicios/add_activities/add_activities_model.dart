...
import 'add_activities_widget.dart' show AddActivitiesWidget;
...
class AddActivitiesModel extends FlutterFlowModel<AddActivitiesWidget> {
  ...
  List<ItineraryItemsRow>? responseActivityDeleted;
