...
class _ItineraryDetailsWidgetState extends State<ItineraryDetailsWidget> {
  ...
  Widget _buildContent(dynamic itineraryData) {
    final itineraryItems = appServices.itinerary.getItineraryItems(int.parse(widget.id!));
    final passengers = appServices.itinerary.getItineraryPassengers(int.parse(widget.id!));
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                if (widget.id != null) {
                  appServices.itinerary.loadItineraryDetails(int.parse(widget.id!));
                }
              },
