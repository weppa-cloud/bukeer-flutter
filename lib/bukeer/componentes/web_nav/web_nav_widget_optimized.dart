...
import '../../core/widgets/navigation/web_nav/web_nav_model.dart';
import '../../../services/user_service.dart';
import '../../../services/authorization_service.dart';
import '../../../services/app_services.dart';
import 'package:bukeer/design_system/tokens/index.dart';
export '../../core/widgets/navigation/web_nav/web_nav_model.dart';
...
class _WebNavWidgetOptimizedState extends State<WebNavWidgetOptimized> {
  ...
  Widget build(BuildContext context) {
    // OPTIMIZATION: Use context.select to only rebuild when specific values change
    final hasLoadedData = context.select<UiStateService, bool>(
      (uiState) => _userService.hasLoadedData,
    );

    // Mostrar indicador de carga mientras se cargan los datos
    if (_isLoadingData) {
      return const _LoadingContainer();
    }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // OPTIMIZATION: Wrap user info in RepaintBoundary
              RepaintBoundary(
...
// OPTIMIZATION: Extract logout button as a separate const widget
...
// OPTIMIZATION: Extract loading container as a separate const widget
