...
import 'component_date_range_model.dart';
export 'component_date_range_model.dart';
...
class ComponentDateRangeWidget extends StatefulWidget {
  ...
  @override
  State<ComponentDateRangeWidget> createState() =>
      _ComponentDateRangeWidgetState();
}

class _ComponentDateRangeWidgetState extends State<ComponentDateRangeWidget> {
  late ComponentDateRangeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComponentDateRangeModel());
