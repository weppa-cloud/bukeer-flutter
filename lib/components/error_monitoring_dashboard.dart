        ...
        child: Column(
          ...
          children: [
            ...
            if (data.mostCommonErrors.isEmpty)
              ...
              ...data.mostCommonErrors.map((error) => 
                ListTile(
        ...
        child: Column(
          ...
          children: [
            ...
            if (data.recentErrors.isEmpty)
              ...
              ...data.recentErrors.take(5).map((error) => 
                ListTile(
                  leading: Icon(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Primera ocurrencia: ${_formatDateTime(pattern.firstOccurrence)}'),
                          Text('Última ocurrencia: ${_formatDateTime(pattern.lastOccurrence)}'),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: data.errorTrends.entries.map((entry) {
                    final maxValue = data.errorTrends.values
                        .reduce((a, b) => a > b ? a : b);
  ...
  void _clearData(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('¿Estás seguro de que quieres eliminar todos los datos de error?'),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: Text('Cancelar'),
