...
import 'package:bukeer/backend/schema/structs/index.dart';
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              requireAuth: true,
              builder: (context, params) => MainUsersWidget(),
            ),
            FFRoute(
              name: EditPersonalProfileWidget.routeName,
              path: EditPersonalProfileWidget.routePath,
              requireAuth: true,
            ...
            FFRoute(
              ...
              path: AddEditTarifaWidget.routePath,
              requireAuth: true,
              builder: (context, params) => AddEditTarifaWidget(
                initialCost: params.getParam(
                  'initialCost',
                  ParamType.double,
                ),
                initialProfit: params.getParam(
                  'initialProfit',
                  ParamType.double,
                ),
                initialTotal: params.getParam(
                  'initialTotal',
                  ParamType.double,
                ),
                typeProduct: params.getParam(
                  'typeProduct',
                  ParamType.String,
                ),
                typeAction: params.getParam(
                  'typeAction',
                  ParamType.String,
                ),
            ...
            FFRoute(
              ...
              requireAuth: true,
              builder: (context, params) => MainProfileAccountWidget(),
            ),
            FFRoute(
              name: MainAgendaWidget.routeName,
              path: MainAgendaWidget.routePath,
              requireAuth: true,
              builder: (context, params) => MainAgendaWidget(),
            ),
            FFRoute(
              name: PreviewItineraryURLWidget.routeName,
              path: PreviewItineraryURLWidget.routePath,
              builder: (context, params) => PreviewItineraryURLWidget(
                id: params.getParam(
                  'id',
                  ParamType.String,
                ),
            ...
            FFRoute(
              name: AddPassengersItineraryWidget.routeName,
              path: AddPassengersItineraryWidget.routePath,
              builder: (context, params) => AddPassengersItineraryWidget(
                allDateHotel: params.getParam(
                  'allDateHotel',
                  ParamType.JSON,
                ),
                id: params.getParam(
            ...
            FFRoute(
              name: AuthResetPasswordWidget.routeName,
              path: AuthResetPasswordWidget.routePath,
              builder: (context, params) => AuthResetPasswordWidget(),
            ),
            FFRoute(
              name: EditPaymentMethodsWidget.routeName,
              path: EditPaymentMethodsWidget.routePath,
              requireAuth: true,
              builder: (context, params) => EditPaymentMethodsWidget(
                name: params.getParam(
                  'name',
                  ParamType.String,
                ),
            ...
            FFRoute(
              name: AddTransferWidget.routeName,
              path: AddTransferWidget.routePath,
              requireAuth: true,
              builder: (context, params) => AddTransferWidget(
                isEdit: params.getParam(
                  'isEdit',
                  ParamType.bool,
                ),
            ...
            FFRoute(
              ...
              requireAuth: true,
              builder: (context, params) => AddFlightsWidget(
                isEdit: params.getParam(
                  'isEdit',
                  ParamType.bool,
                ),
            ...
            FFRoute(
              ...
              requireAuth: true,
              builder: (context, params) => ReporteVentasWidget(),
            ),
            FFRoute(
              name: ReporteCuentasPorPagarWidget.routeName,
              path: ReporteCuentasPorPagarWidget.routePath,
              requireAuth: true,
              builder: (context, params) => ReporteCuentasPorPagarWidget(),
            ),
            FFRoute(
              name: ReporteCuentasPorCobrarWidget.routeName,
              path: ReporteCuentasPorCobrarWidget.routePath,
              requireAuth: true,
              builder: (context, params) => ReporteCuentasPorCobrarWidget(),
            ),
            FFRoute(
              name: ItineraryDetailsWidget.routeName,
              path: ItineraryDetailsWidget.routePath,
              requireAuth: true,
              builder: (context, params) => ItineraryDetailsWidget(
                allDateHotel: params.getParam(
                  'allDateHotel',
                  ParamType.JSON,
                ),
