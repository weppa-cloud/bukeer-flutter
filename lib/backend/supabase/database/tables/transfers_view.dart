...
class TransfersViewTable extends SupabaseTable<TransfersViewRow> {
  @override
  String get tableName => 'transfers_view';

  @override
  TransfersViewRow createRow(Map<String, dynamic> data) =>
      TransfersViewRow(data);
}

class TransfersViewRow extends SupabaseDataRow {
  TransfersViewRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => TransfersViewTable();
