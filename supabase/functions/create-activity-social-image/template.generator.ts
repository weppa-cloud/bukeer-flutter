...
export function generateActivitySocialImageHtml(data) {
  ...
  const mainImageUrl = activity.main_image ? getOptimizedImageUrl(activity.main_image, 1200, 100) : "https://via.placeholder.com/800x600.png?text=Main+Image+Missing";
  ...
  // Color de fondo para la sección de galería - Borde verde más delgado
      ...
      <div style="width: 100%; height: 100%; display: flex; flex-direction: column;">
        <div style="position: relative; flex: ${hasGallery ? '0.75' : '1'}; overflow: hidden;">
          ...
          <div style="position: absolute; bottom: 0; left: 0; width: 100%; padding: 30px 20px 25px 20px; 
                      background: linear-gradient(to bottom, rgba(16,53,43,0) 0%, rgba(16,53,43,0.1) 20%, rgba(16,53,43,0.6) 70%, rgba(16,53,43,0.8) 100%);
